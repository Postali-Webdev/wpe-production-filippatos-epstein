...
// set up labels
    ...
    register_post_type( 'Attorneys', array(
        ...
        'rewrite' => array( 'slug' => 'about/our-team', 'with_front' => false ), // Has /about/ as pre front for the theme, if there are more then attorneys to be listed under here this need removed
        )
    );
